...
class FieldsMapper:
    ...
    def dict_to_model(_dict: dict) -> Fields:
        return Fields(issuetype=IssueTypeMapper.dict_to_model(_dict=_dict.get("issuetype")),
                      ...
                      resolutiondate=datetime.strptime(_dict.get("resolutiondate"),"%Y-%m-%dT%H:%M:%S.%f%z") if _dict.get(
                          "resolutiondate") is not None else [],
                      ...
                      versions=[VersionMapper.dict_to_model(_dict=version) for version in _dict.get("versions")] if _dict.get("versions") is not None else None,
                      issuelinks=_dict.get("issueLinks"),
                      assignee=UserMapper.dict_to_model(_dict=_dict.get("assignee")) if _dict.get("assignee") is not None else None,
                      ...
                      creator=UserMapper.dict_to_model(_dict=_dict.get("creator")) if _dict.get("creator") is not None else None,
                      subtasks=[subtask for subtask in _dict.get("subtasks")],
                      reporter=UserMapper.dict_to_model(_dict=_dict.get("reporter")) if _dict.get("reporter") is not None else None,
